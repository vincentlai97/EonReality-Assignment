...
namespace UnityEngine.UI.Extensions
{
    ...
    public class TableLayoutGroup : LayoutGroup
    {
        ...
        public int GetChildIndex(RectTransform child)
        {
            return rectChildren.IndexOf(child);
        }

        public int GetRow(RectTransform child)
        {
            int index = rectChildren.IndexOf(child);
            return index == -1 ? index : rectChildren.IndexOf(child) / columnWidths.Length;
        }
    }
}